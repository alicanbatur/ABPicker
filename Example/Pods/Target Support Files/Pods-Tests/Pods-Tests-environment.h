...
// ABPicker
#define COCOAPODS_POD_AVAILABLE_ABPicker
#define COCOAPODS_VERSION_MAJOR_ABPicker 0
#define COCOAPODS_VERSION_MINOR_ABPicker 1
#define COCOAPODS_VERSION_PATCH_ABPicker 0
